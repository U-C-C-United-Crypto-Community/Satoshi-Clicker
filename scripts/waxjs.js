...
var waxjs = function (t) {
  ...
  function y(t, e) {
    ...
    for (var r = Array(e).fill("0".charCodeAt(0)), n = t.length - 1; n >= 0; --n) {
      ...
      for (; o;) {
        r.push("0".charCodeAt(0) + o % 10), o = o / 10 | 0;
      }
    }
  ...
  function g(t, e) {
    ...
    try {
      for (var f = o(t), h = f.next(); !h.done; h = f.next()) {
        ...
        for (; p;) {
          l.push(s.charCodeAt(p % 58)), p = p / 58 | 0;
        }
      }
    } catch (t) {
      r = {
  ...
  function w(t, e, r) {
    for (var n = new Uint8Array(b(t.data, e)), i = new Uint8Array(t.data.length + 4), o = 0; o < t.data.length; ++o) {
      i[o] = t.data[o];
    }

    for (o = 0; o < 4; ++o) {
      i[o + t.data.length] = n[o];
    }
  ...
  var c = function () {
    ...
    return t.prototype.reserve = function (t) {
      ...
      for (var r = new Uint8Array(8), n = 63, i = 0; i < t.length; ++i) {
        ...
        for (var a = 4; a >= 0; --a) {
          n >= 0 && (r[Math.floor(n / 8)] |= (o >> a & 1) << n % 8, --n);
        }
      }
      ...
      for (var t = this.getUint8Array(8), e = "", r = 63; r >= 0;) {
        for (var n = 0, i = 0; i < 5; ++i) {
          r >= 0 && (n = n << 1 | t[Math.floor(r / 8)] >> r % 8 & 1, --r);
        }
      ...
      for (var i = !1; e < t.length && t.charCodeAt(e) >= "0".charCodeAt(0) && t.charCodeAt(e) <= "9".charCodeAt(0);) {
        i = !0, r += t[e], ++e;
      }

      if (!i) throw new Error("Asset must begin with a number");
      if ("." === t[e]) for (++e; e < t.length && t.charCodeAt(e) >= "0".charCodeAt(0) && t.charCodeAt(e) <= "9".charCodeAt(0);) {
        r += t[e], ++n, ++e;
      }
  ...
  function x(t, e, r, n) {
    var i, o;
    if (void 0 === r && (r = new u()), void 0 === n && (n = !0), "object" != _typeof(e)) throw new Error("expected object containing data: " + JSON.stringify(e));
  ...
  e.SerialBuffer = c, e.supportedAbiVersion = function (t) {
    ...
    var t = new Map(Object.entries({
      ...
      bytes: D({
        ...
        deserialize: function deserialize(t, e) {
        ...
        return o(this, function (o) {
          switch (o.label) {
            ...
            case 1:
              ...
              try {
                for (u = c(i.actions), f = u.next(); !f.done; f = u.next()) {
                  h = f.value, p = h.name, d = h.type, s.set(p, l.getType(a, d));
                }
              } catch (t) {
                r = {
                  error: t
        ...
        return i(this, function (l) {
          switch (l.label) {
            ...
            case 3:
              ...
              return void 0 === e ? [2, o] : (s = function s(t) {
                ...
                return i(this, function (i) {
                  switch (i.label) {
                    case 0:
                      ...
                      if ("object" != _typeof(u.data)) return [2];
                      i.label = 1;
