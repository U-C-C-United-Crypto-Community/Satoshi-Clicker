var waxjs = function (t) {
  ...
  function _(t) {
    ...
    if ("EOS" === t.substr(0, 3)) {
      for (var r = v(e.publicKeyDataSize + 4, t.substr(3)), n = { type: l.k1, data: new Uint8Array(e.publicKeyDataSize) }, i = 0; i < e.publicKeyDataSize; ++i) n.data[i] = r[i];
  ...
  var c = function () {
    function t(t) {
      var e = void 0 === t ? {} : t,
          ...
          n = e.textDecoder,
          i = e.array;
      this.readPos = 0, this.array = i || new Uint8Array(1024), this.length = i ? i.length : 0, this.textEncoder = r || new TextEncoder(), this.textDecoder = n || new TextDecoder("utf-8", { fatal: !0 });
    }
    return t.prototype.reserve = function (t) {
      ...
      if ("." === t[e]) for (++e; e < t.length && t.charCodeAt(e) >= "0".charCodeAt(0) && t.charCodeAt(e) <= "9".charCodeAt(0);) r += t[e], ++n, ++e;
      var o = t.substr(e).trim();
      this.pushArray(s.signedDecimalToBinary(8, r)), this.pushSymbol({ name: o, precision: n });
  ...
  e.SerialBuffer = c, e.supportedAbiVersion = function (t) {
    ...
    return t.set("extended_asset", D({
      name: "extended_asset",
      baseName: "",
      fields: [{ name: "quantity", typeName: "asset", type: t.get("asset") }, { name: "contract", typeName: "name", type: t.get("name") }],
      serialize: x,
      deserialize: S
    })), t;
    ...
    return t.prototype.login = function () {
      ...
      return n(this, void 0, void 0, function () {
        ...
        return i(this, function (n) {
          switch (n.label) {
            case 0:
              return [4, this.waxEventSource.openEventSource(this.waxSigningURL + "/cloud-wallet/signing/", { type: "TRANSACTION", transaction: e }, t)];
            case 1:
      ...
      return void 0 === e && (e = !1), i(this, void 0, void 0, function () {
        ...
        return o(this, function (o) {
          switch (o.label) {
            ...
            case 2:
              return n = o.sent().abi, i = this.rawAbiToJson(n), r = { rawAbi: n, abi: i }, [3, 4];
            case 3:
          ...
          return r = t.actions.map(function (t) {
            ...
            return i(s, void 0, void 0, function () {
              ...
              return o(this, function (n) {
                switch (n.label) {
                  case 0:
                    return r = { accountName: t }, [4, this.getCachedAbi(t, e)];
                  case 1:
        ...
        return o(this, function (o) {
          switch (o.label) {
            ...
            case 1:
              ...
              return y = { types: a, actions: s }, this.contracts.set(t, y), [2, y];
          }
        });
      });
      ...
      return i(this, void 0, void 0, function () {
        ...
        return o(this, function (o) {
          switch (o.label) {
            ...
            case 8:
              return t = n.apply(void 0, a.concat([(u.actions = o.sent(), u)])), p = this.serializeTransaction(t), d = { serializedTransaction: p, signatures: [] }, c ? [4, this.signatureProvider.getAvailableKeys()] : [3, 12];
            case 9:
        ...
        return n(this, void 0, void 0, function () {
          ...
          return i(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return e = n.sent(), r = a.base64ToBinary(e.abi), [2, { accountName: e.account_name, abi: r }];
            }
          });
        });
